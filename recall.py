...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 17:14:32 2019
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 16:29:33 2019
...
#########################################
   ...
   # for item in arr3:
    ...
    dictMSD={}  
    z=0#likely to be predicted
    i=0#atmost item to be predicted
    for i in range(len(userMain)):
    ...
    #    print("No item to predict according to MSD")
     ...
     #   print("Following item should be predicted to active user according to MSD are:-")        
      #  for item in itempreMSD:
       #     print(item)
    i=len(itempreMSD)
    for item in userMain:
        if(not(pd.isnull(item)) and item>3):
            z+=1
    arrreturn.append(i/z)
...
for i in range(len(dataset)):
    ...
    sumCS+=pc[1]
    sumPC+=pc[2]
print("According to MSD:-{}".format(sumMSD/size))
print("According to cosine Similarity:-{}".format(sumCS/size))
print("According to Pearson COrrelation-:{}".format(sumPC/size))
